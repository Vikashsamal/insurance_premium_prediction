...
class DataValidation:
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            base_df = self.drop_missing_values_columns(df=base_df, report_key_name="Missing_vlaue_within_base_data")
            ...
            train_df = self.drop_missing_values_columns(df=train_df, report_key_name="Missing_vlaue_within_train_data")
            test_df = self.drop_missing_values_columns(df=test_df, report_key_name="Missing_vlaue_within_test_data")
