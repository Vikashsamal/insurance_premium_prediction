...
from Insurance.components import data_transformation
...
# Set thresold to accept or reject new data
    ...
    def initiate_model_trainer(self,)-> artifact_entity.ModelTrainerArtifact:
        ...
        try:
            ...
            if diff > self.model_trainer_config.overfitting_threshold:
                raise Exception(f"Train model and test score diff: {diff} is more than overfitting thresold {self.model_trainer_config.overfitting_threshold}")
